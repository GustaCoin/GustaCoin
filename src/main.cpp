...
uint256 hashGenesisBlock("0xdc4c79d7908e18d9c76bcdc6ecae3618195bd88a6e0ff907689a0b5dff4950cb");
...
const string strMessageMagic = "gustacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 12 * 60 * 60; // gustacoin: 12 hours difficulty retarget
static const int64 nTargetSpacing = 90; // gustacoin: 90 seconds block
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal gustacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "gustacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7390276521f25dea8b26becec86338e6428e16516bbbd910d0acdad895a924bc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Guardian - 12 Jan 2014 - Brussels slaps down British threats to rewrite immigration rules";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390059533; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1340683;

        if (fTestNet)
        {
            block.nTime    = 1389537375;
            block.nNonce   = 644994;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3b6ec21b184d1ca76bef96a143544dd8e5cc9337dc8d565a8686ba4eaaf162bf"));
