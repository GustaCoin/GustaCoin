...
static const int64 MAX_MONEY = 10000000 * COIN; // maximum number of coins will be 10 million
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 960 / 250; // 960 blocks found a day. Priority cutoff is 1 GUS day / 250 bytes. 960
    }
